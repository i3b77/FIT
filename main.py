...
mydb = mysql.connector.connect(
    host='db-mysql-blr1-77519-do-user-14717504-0.b.db.ondigitalocean.com',
    port=25060,
    user='doadmin',
    password="AVNS_niuIQ2r7V7aSoTYroXP",
    database='fitness',
    )
...
def add_exercises_to_plan():
    ...
    try:
        ...
        if not plan_id:
            ...
            insert_plan_query = "INSERT INTO plan (user_user_id1, level) VALUES (%s, %s)"
            my_cursor.execute(insert_plan_query, (user_id, level))
            mydb.commit()
