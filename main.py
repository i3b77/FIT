...
def add_exercises_to_plan():
    ...
    try:
        ...
        if not plan_id:
            ...
            insert_plan_query = "INSERT INTO plan (user_user_id1, level, plan_name, status) VALUES (%s, %s, %s, %s)"
            my_cursor.execute(insert_plan_query, (user_id, level, plan_name, "Active"))
            mydb.commit()
